...
export function ZoomInIcon(props: SVGProps<SVGSVGElement>) {
  ...
  <path fill="#2E2F32" d="M14.5 2.001c6.904 0 12.5 5.596 12.5 12.5 0 3.02-1.071 5.789-2.854 7.95l5.86 5.859-1.697 1.696-5.859-5.858A12.45 12.45 0 0 1 14.5 27C7.597 27 2 21.403 2 14.5 2 7.596 7.596 2 14.5 2Zm0 2.4C8.922 4.4 4.4 8.922 4.4 14.5s4.522 10.1 10.1 10.1c5.578 0 10.1-4.522 10.1-10.1 0-5.578-4.522-10.1-10.1-10.1Zm1 9.1h5v2h-5v5h-2v-5h-5v-2h5v-5h2v5Z"/>
</svg>
  );
}
