...
export function ThemeEditorSection() {
  ...
  return (
    <div className={styles.themeSection}>
      <div>
        <h2 className={styles.themeSectionTitle}>{t('projectSettings.themeTitle')}</h2>
        <p className={styles.themeSectionDesc}>
          {t('projectSettings.themeDesc')}
        </p>
      </div>
