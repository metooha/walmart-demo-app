...
// WCP Navigation icons (mono-color, use currentColor)
export { WCPFavorites } from './WCPFavorites';
export { WCPFavoritesFill } from './WCPFavoritesFill';
export { WCPSearchMenu } from './WCPSearchMenu';
export { WCPSearchMenuFill } from './WCPSearchMenuFill';
export { WCPShoppingBag } from './WCPShoppingBag';
export { WCPShoppingBagFill } from './WCPShoppingBagFill';
